...
cd $CurrentPath
pkill XEngine
./XEngine --name=Gate --modules='Gate;Db' --DbGroupCount=10 --MysqlHost=127.0.0.1 --MysqlPort=3306 --MysqlDb=game --MysqlUsername=xgame --MysqlPassword=abc123123 --RedisHost=127.0.0.1 --RedisPort=6379 --PortForClient=18888 --GameServerPort=5000 --log=./Log &
...
./XEngine --name=Cache --modules='Cache;Db;SQLCache' --DbGroupCount=10 --MysqlHost=127.0.0.1 --MysqlPort=3306 --MysqlDb=game --MysqlUsername=xgame --MysqlPassword=abc123123 --RedisHost=127.0.0.1 --RedisPort=6379 --PortForGame=6000 --log=./Log &
