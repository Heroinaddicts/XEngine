...
namespace UnitCommon {
    ...
    namespace Equip {
        enum {
            ...
            ItemTypeInt32 = 51, //
            CountInt32 = 52, //
            IsFirstCreateBool = 53, //
            StartPosVector2 = 54, //
            EndPosVector2 = 55, //
            StartTimeInt64 = 56, //
            CotrolPointVector2 = 57, //
            EquipTypeInt32 = 58, //
            EquipedBool = 59, //
            PatienceInt32 = 60, //
            StrengthLvInt32 = 61, //

            __AttributeCount__ = 62
        };

        constexpr const eGameObjectType Types[] = { eGameObjectType::Equip, eGameObjectType::Item, eGameObjectType::Entity,  eGameObjectType::__AllType__ };
        constexpr const int TypesCount = 3;
    }
    namespace Item {
        enum {
            ...
            __AttributeCount__ = 58
        };

        constexpr const eGameObjectType Types[] = { eGameObjectType::Item, eGameObjectType::Entity,  eGameObjectType::__AllType__ };
        constexpr const int TypesCount = 2;
    }
    namespace Launcher {
        enum {
    ...
    switch (type) { \
        ...
        { \
            go = GameObject::Create("Equip", type, guid, config, Equip::__AttributeCount__, \
                [](GameObject* const go, Attribute** const attributes) { \
                    attributes[Equip::SpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "Speed", Equip::SpeedFloat, true, true); \
                    attributes[Equip::SceneGUIDUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "SceneGUID", Equip::SceneGUIDUInt64, false, false); \
                    attributes[Equip::LastPublicSceneConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "LastPublicSceneConfigID", Equip::LastPublicSceneConfigIDInt64, false, false); \
                    attributes[Equip::CopySceneGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "CopySceneGuid", Equip::CopySceneGuidUInt64, false, false); \
                    attributes[Equip::NicknameString] = Attribute::Create(go, eAttributeType::__String__, "Nickname", Equip::NicknameString, false, false); \
                    attributes[Equip::LevelInt64] = Attribute::Create(go, eAttributeType::__Int64__, "Level", Equip::LevelInt64, true, true); \
                    attributes[Equip::LastUpdatePositionTickUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "LastUpdatePositionTick", Equip::LastUpdatePositionTickUInt64, false, false); \
                    attributes[Equip::WhoAttkMeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "WhoAttkMe", Equip::WhoAttkMeUInt64, false, false); \
                    attributes[Equip::AtkFloat] = Attribute::Create(go, eAttributeType::__Float__, "Atk", Equip::AtkFloat, true, true); \
                    attributes[Equip::HpFloat] = Attribute::Create(go, eAttributeType::__Float__, "Hp", Equip::HpFloat, true, true); \
                    attributes[Equip::MaxHpFloat] = Attribute::Create(go, eAttributeType::__Float__, "MaxHp", Equip::MaxHpFloat, true, true); \
                    attributes[Equip::CriticalFloat] = Attribute::Create(go, eAttributeType::__Float__, "Critical", Equip::CriticalFloat, true, true); \
                    attributes[Equip::CriticalDamageFloat] = Attribute::Create(go, eAttributeType::__Float__, "CriticalDamage", Equip::CriticalDamageFloat, true, true); \
                    attributes[Equip::DefendFloat] = Attribute::Create(go, eAttributeType::__Float__, "Defend", Equip::DefendFloat, true, true); \
                    attributes[Equip::MagicDefendFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicDefend", Equip::MagicDefendFloat, true, true); \
                    attributes[Equip::BloodFloat] = Attribute::Create(go, eAttributeType::__Float__, "Blood", Equip::BloodFloat, true, true); \
                    attributes[Equip::MagicAttackFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicAttack", Equip::MagicAttackFloat, true, true); \
                    attributes[Equip::PhysicalPierceFloat] = Attribute::Create(go, eAttributeType::__Float__, "PhysicalPierce", Equip::PhysicalPierceFloat, true, true); \
                    attributes[Equip::PhysicalPierceRateFloat] = Attribute::Create(go, eAttributeType::__Float__, "PhysicalPierceRate", Equip::PhysicalPierceRateFloat, true, true); \
                    attributes[Equip::MagicPierceFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicPierce", Equip::MagicPierceFloat, true, true); \
                    attributes[Equip::MagicPierceRateFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicPierceRate", Equip::MagicPierceRateFloat, true, true); \
                    attributes[Equip::AffordFloat] = Attribute::Create(go, eAttributeType::__Float__, "Afford", Equip::AffordFloat, true, true); \
                    attributes[Equip::DodgeFloat] = Attribute::Create(go, eAttributeType::__Float__, "Dodge", Equip::DodgeFloat, true, true); \
                    attributes[Equip::ResilienceFloat] = Attribute::Create(go, eAttributeType::__Float__, "Resilience", Equip::ResilienceFloat, true, true); \
                    attributes[Equip::VisualFieldFloat] = Attribute::Create(go, eAttributeType::__Float__, "VisualField", Equip::VisualFieldFloat, true, true); \
                    attributes[Equip::DamageReductionFloat] = Attribute::Create(go, eAttributeType::__Float__, "DamageReduction", Equip::DamageReductionFloat, true, true); \
                    attributes[Equip::MpFloat] = Attribute::Create(go, eAttributeType::__Float__, "Mp", Equip::MpFloat, true, true); \
                    attributes[Equip::MaxMpFloat] = Attribute::Create(go, eAttributeType::__Float__, "MaxMp", Equip::MaxMpFloat, true, true); \
                    attributes[Equip::AtkSpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "AtkSpeed", Equip::AtkSpeedFloat, true, true); \
                    attributes[Equip::CantControllerRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "CantControllerRef", Equip::CantControllerRefInt32, true, true); \
                    attributes[Equip::SilentRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "SilentRef", Equip::SilentRefInt32, true, true); \
                    attributes[Equip::InvincibleRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "InvincibleRef", Equip::InvincibleRefInt32, true, true); \
                    attributes[Equip::RestraintRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "RestraintRef", Equip::RestraintRefInt32, true, true); \
                    attributes[Equip::ShiftRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "ShiftRef", Equip::ShiftRefInt32, true, true); \
                    attributes[Equip::ExtraAddExpFloat] = Attribute::Create(go, eAttributeType::__Float__, "ExtraAddExp", Equip::ExtraAddExpFloat, false, false); \
                    attributes[Equip::MoveSkillConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "MoveSkillConfigID", Equip::MoveSkillConfigIDInt64, false, false); \
                    attributes[Equip::SkillAngleFloat] = Attribute::Create(go, eAttributeType::__Float__, "SkillAngle", Equip::SkillAngleFloat, false, false); \
                    attributes[Equip::MoveSkillTargetGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "MoveSkillTargetGuid", Equip::MoveSkillTargetGuidUInt64, false, false); \
                    attributes[Equip::SkillTargetPosVector2] = Attribute::Create(go, eAttributeType::__Vector2__, "SkillTargetPos", Equip::SkillTargetPosVector2, false, false); \
                    attributes[Equip::DamagePriorityInt32] = Attribute::Create(go, eAttributeType::__Int32__, "DamagePriority", Equip::DamagePriorityInt32, true, true); \
                    attributes[Equip::LastSkillConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "LastSkillConfigID", Equip::LastSkillConfigIDInt64, false, false); \
                    attributes[Equip::LastSkillUseTimeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "LastSkillUseTime", Equip::LastSkillUseTimeUInt64, false, false); \
                    attributes[Equip::CastIsTrackOnCollisionBool] = Attribute::Create(go, eAttributeType::__Bool__, "CastIsTrackOnCollision", Equip::CastIsTrackOnCollisionBool, false, false); \
                    attributes[Equip::IsCantDamagedBool] = Attribute::Create(go, eAttributeType::__Bool__, "IsCantDamaged", Equip::IsCantDamagedBool, true, true); \
                    attributes[Equip::TeamGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "TeamGuid", Equip::TeamGuidUInt64, true, true); \
                    attributes[Equip::MoveSpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "MoveSpeed", Equip::MoveSpeedFloat, true, true); \
                    attributes[Equip::HpRecoverFloat] = Attribute::Create(go, eAttributeType::__Float__, "HpRecover", Equip::HpRecoverFloat, true, true); \
                    attributes[Equip::MpRecoverFloat] = Attribute::Create(go, eAttributeType::__Float__, "MpRecover", Equip::MpRecoverFloat, true, true); \
                    attributes[Equip::IsTeamLeaderBool] = Attribute::Create(go, eAttributeType::__Bool__, "IsTeamLeader", Equip::IsTeamLeaderBool, true, true); \
                    attributes[Equip::BattleStartTimeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "BattleStartTime", Equip::BattleStartTimeUInt64, true, false); \
        ...
        { \
            go = GameObject::Create("Item", type, guid, config, Item::__AttributeCount__, \
                [](GameObject* const go, Attribute** const attributes) { \
                    attributes[Item::SpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "Speed", Item::SpeedFloat, true, true); \
                    attributes[Item::SceneGUIDUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "SceneGUID", Item::SceneGUIDUInt64, false, false); \
                    attributes[Item::LastPublicSceneConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "LastPublicSceneConfigID", Item::LastPublicSceneConfigIDInt64, false, false); \
                    attributes[Item::CopySceneGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "CopySceneGuid", Item::CopySceneGuidUInt64, false, false); \
                    attributes[Item::NicknameString] = Attribute::Create(go, eAttributeType::__String__, "Nickname", Item::NicknameString, false, false); \
                    attributes[Item::LevelInt64] = Attribute::Create(go, eAttributeType::__Int64__, "Level", Item::LevelInt64, true, true); \
                    attributes[Item::LastUpdatePositionTickUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "LastUpdatePositionTick", Item::LastUpdatePositionTickUInt64, false, false); \
                    attributes[Item::WhoAttkMeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "WhoAttkMe", Item::WhoAttkMeUInt64, false, false); \
                    attributes[Item::AtkFloat] = Attribute::Create(go, eAttributeType::__Float__, "Atk", Item::AtkFloat, true, true); \
                    attributes[Item::HpFloat] = Attribute::Create(go, eAttributeType::__Float__, "Hp", Item::HpFloat, true, true); \
                    attributes[Item::MaxHpFloat] = Attribute::Create(go, eAttributeType::__Float__, "MaxHp", Item::MaxHpFloat, true, true); \
                    attributes[Item::CriticalFloat] = Attribute::Create(go, eAttributeType::__Float__, "Critical", Item::CriticalFloat, true, true); \
                    attributes[Item::CriticalDamageFloat] = Attribute::Create(go, eAttributeType::__Float__, "CriticalDamage", Item::CriticalDamageFloat, true, true); \
                    attributes[Item::DefendFloat] = Attribute::Create(go, eAttributeType::__Float__, "Defend", Item::DefendFloat, true, true); \
                    attributes[Item::MagicDefendFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicDefend", Item::MagicDefendFloat, true, true); \
                    attributes[Item::BloodFloat] = Attribute::Create(go, eAttributeType::__Float__, "Blood", Item::BloodFloat, true, true); \
                    attributes[Item::MagicAttackFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicAttack", Item::MagicAttackFloat, true, true); \
                    attributes[Item::PhysicalPierceFloat] = Attribute::Create(go, eAttributeType::__Float__, "PhysicalPierce", Item::PhysicalPierceFloat, true, true); \
                    attributes[Item::PhysicalPierceRateFloat] = Attribute::Create(go, eAttributeType::__Float__, "PhysicalPierceRate", Item::PhysicalPierceRateFloat, true, true); \
                    attributes[Item::MagicPierceFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicPierce", Item::MagicPierceFloat, true, true); \
                    attributes[Item::MagicPierceRateFloat] = Attribute::Create(go, eAttributeType::__Float__, "MagicPierceRate", Item::MagicPierceRateFloat, true, true); \
                    attributes[Item::AffordFloat] = Attribute::Create(go, eAttributeType::__Float__, "Afford", Item::AffordFloat, true, true); \
                    attributes[Item::DodgeFloat] = Attribute::Create(go, eAttributeType::__Float__, "Dodge", Item::DodgeFloat, true, true); \
                    attributes[Item::ResilienceFloat] = Attribute::Create(go, eAttributeType::__Float__, "Resilience", Item::ResilienceFloat, true, true); \
                    attributes[Item::VisualFieldFloat] = Attribute::Create(go, eAttributeType::__Float__, "VisualField", Item::VisualFieldFloat, true, true); \
                    attributes[Item::DamageReductionFloat] = Attribute::Create(go, eAttributeType::__Float__, "DamageReduction", Item::DamageReductionFloat, true, true); \
                    attributes[Item::MpFloat] = Attribute::Create(go, eAttributeType::__Float__, "Mp", Item::MpFloat, true, true); \
                    attributes[Item::MaxMpFloat] = Attribute::Create(go, eAttributeType::__Float__, "MaxMp", Item::MaxMpFloat, true, true); \
                    attributes[Item::AtkSpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "AtkSpeed", Item::AtkSpeedFloat, true, true); \
                    attributes[Item::CantControllerRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "CantControllerRef", Item::CantControllerRefInt32, true, true); \
                    attributes[Item::SilentRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "SilentRef", Item::SilentRefInt32, true, true); \
                    attributes[Item::InvincibleRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "InvincibleRef", Item::InvincibleRefInt32, true, true); \
                    attributes[Item::RestraintRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "RestraintRef", Item::RestraintRefInt32, true, true); \
                    attributes[Item::ShiftRefInt32] = Attribute::Create(go, eAttributeType::__Int32__, "ShiftRef", Item::ShiftRefInt32, true, true); \
                    attributes[Item::ExtraAddExpFloat] = Attribute::Create(go, eAttributeType::__Float__, "ExtraAddExp", Item::ExtraAddExpFloat, false, false); \
                    attributes[Item::MoveSkillConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "MoveSkillConfigID", Item::MoveSkillConfigIDInt64, false, false); \
                    attributes[Item::SkillAngleFloat] = Attribute::Create(go, eAttributeType::__Float__, "SkillAngle", Item::SkillAngleFloat, false, false); \
                    attributes[Item::MoveSkillTargetGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "MoveSkillTargetGuid", Item::MoveSkillTargetGuidUInt64, false, false); \
                    attributes[Item::SkillTargetPosVector2] = Attribute::Create(go, eAttributeType::__Vector2__, "SkillTargetPos", Item::SkillTargetPosVector2, false, false); \
                    attributes[Item::DamagePriorityInt32] = Attribute::Create(go, eAttributeType::__Int32__, "DamagePriority", Item::DamagePriorityInt32, true, true); \
                    attributes[Item::LastSkillConfigIDInt64] = Attribute::Create(go, eAttributeType::__Int64__, "LastSkillConfigID", Item::LastSkillConfigIDInt64, false, false); \
                    attributes[Item::LastSkillUseTimeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "LastSkillUseTime", Item::LastSkillUseTimeUInt64, false, false); \
                    attributes[Item::CastIsTrackOnCollisionBool] = Attribute::Create(go, eAttributeType::__Bool__, "CastIsTrackOnCollision", Item::CastIsTrackOnCollisionBool, false, false); \
                    attributes[Item::IsCantDamagedBool] = Attribute::Create(go, eAttributeType::__Bool__, "IsCantDamaged", Item::IsCantDamagedBool, true, true); \
                    attributes[Item::TeamGuidUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "TeamGuid", Item::TeamGuidUInt64, true, true); \
                    attributes[Item::MoveSpeedFloat] = Attribute::Create(go, eAttributeType::__Float__, "MoveSpeed", Item::MoveSpeedFloat, true, true); \
                    attributes[Item::HpRecoverFloat] = Attribute::Create(go, eAttributeType::__Float__, "HpRecover", Item::HpRecoverFloat, true, true); \
                    attributes[Item::MpRecoverFloat] = Attribute::Create(go, eAttributeType::__Float__, "MpRecover", Item::MpRecoverFloat, true, true); \
                    attributes[Item::IsTeamLeaderBool] = Attribute::Create(go, eAttributeType::__Bool__, "IsTeamLeader", Item::IsTeamLeaderBool, true, true); \
                    attributes[Item::BattleStartTimeUInt64] = Attribute::Create(go, eAttributeType::__UInt64__, "BattleStartTime", Item::BattleStartTimeUInt64, true, false); \
