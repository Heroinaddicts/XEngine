...
{
    public class CharacterStrengthen
    {
        ...
        public readonly static ReadOnlyDictionary<Int64, CharacterStrengthen> Datas = new ReadOnlyDictionary<Int64, CharacterStrengthen>(
            new Dictionary<Int64, CharacterStrengthen>() {
                {1001, new CharacterStrengthen(1001, 0.25f, 0.26f, 0.27f, 0.28f, 0.29f, 0.30f, 0.31f, 0.32f, 0.33f, 0.34f, 0.35f, 0.36f, 0.37f)},
            }
        );
        public static CharacterStrengthen Get(Int64 id) {
            CharacterStrengthen config = null; if (Datas.TryGetValue(id, out config)) return config; return null;
        }
    }
}
