...
public class ExportScene : EditorWindow
{
    ...
    [MenuItem("ExportScene/ExportSelectedToSingleObj")]
    [MenuItem("GameObject/ExportScene/ExportSelectedToSingleObj", priority = 44)]
    ...
    {
        string dataPath = Application.dataPath + "/../../Public/RecastNavgation/Meshes";
