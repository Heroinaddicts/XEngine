...
namespace XEngine {
    ...
    public:
        ...
        virtual void LogAsync(const char* header, const char* content, const bool console, const char* file, const int line) override;
        virtual void LogSync(const char* header, const char* content, const bool console, const char* file, const int line) override;
