...
namespace XEngine {
    ...
    void Log::LogAsync(const char* header, const char* content, const bool console, const char* file, const int line) {
        AUTO_LOCK(_AsyncLogLock);
    ...
    void Log::LogSync(const char* header, const char* content, const bool console, const char* file, const int line) {
