...
namespace XEngine {
    ...
    public:
        ...
        virtual void KillTimer(Api::iTimer* timer, const int id, const UInt64 context, const char* file, const int line) override;
        ...
        virtual bool IsExistsTimer(Api::iTimer* timer, const int id, const UInt64 context = 0) override;
    ...
    private:
        ...
        void _Update_();
        void Remove(TimeBase* base, const char* file, const int line);
