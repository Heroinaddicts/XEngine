...
namespace XEngine {
    ...
    Api::iPhysxTriangleMesh* PhysxScene::CreateTriangleMesh(const Api::eRigType type, const Vector3& pos, const Quaternion& qt, const float scale, const Api::eMeshFileType meshfiletype, const std::string& file, Api::iPhysxContext* context) {
        return nullptr;
        //         Engine::GetInstance()->GetMeshLoaderApi()->LoadObjAsync(file, xnew Api::MeshData(), [=](bool res, Api::MeshData* const data) -> void {
        // 
